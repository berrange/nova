...
class LibvirtConfigObject(object):
    ...
    def __init__(self, **kwargs):
        ...
        self.ns_uri = None
        self.ns_prefix = None
        if 'ns_prefix' in kwargs:
            self.ns_prefix = kwargs['ns_prefix']
        if 'ns_uri' in kwargs:
            self.ns_uri = kwargs['ns_uri']

        if "xmlstr" in kwargs:
            self.parse_dom(kwargs["xmlstr"])
    ...
    def format_dom(self):
        if self.ns_prefix is None:
            return etree.Element(self.rootname)
        else:
            return etree.Element("{" + self.ns_uri + "}" + self.rootname,
    ...
    def to_xml(self, pretty_print=True):
        ...
        xmlstr = etree.tostring(root, pretty_print=pretty_print)
        LOG.debug("Generated XML %s " % (xmlstr,))
        return xmlstr
...
class LibvirtConfigGuestDisk(LibvirtConfigGuestDevice):
    ...
    def __init__(self, **kwargs):
        super(LibvirtConfigGuestDisk, self).__init__(rootname="disk", **kwargs)
    ...
    def format_dom(self):
        ...
        if self.driver_name is not None or self.driver_format is not None:
        ...
        if self.source_type == "mount":
            ...
            dev.append(etree.Element("target", dev=self.target_dev, bus=self.target_bus))
...
class LibvirtConfigGuestFilesys(LibvirtConfigGuestDevice):
    ...
    def __init__(self, **kwargs):
        super(LibvirtConfigGuestFilesys, self).__init__(rootname="filesystem", **kwargs)
...
class LibvirtConfigGuestInterface(LibvirtConfigGuestDevice):
    ...
    def __init__(self, **kwargs):
        super(LibvirtConfigGuestInterface, self).__init__(rootname="interface", **kwargs)
    ...
    def format_dom(self):
        ...
        if self.net_type == "ethernet":
            ...
            dev.append(etree.Element("source", dev=self.source_dev, mode="private"))
        else:
...
class LibvirtConfigGuestInput(LibvirtConfigGuestDevice):
    ...
    def __init__(self, **kwargs):
        super(LibvirtConfigGuestInput, self).__init__(rootname="input", **kwargs)
...
class LibvirtConfigGuestGraphics(LibvirtConfigGuestDevice):
    ...
    def __init__(self, **kwargs):
        super(LibvirtConfigGuestGraphics, self).__init__(rootname="graphics", **kwargs)
...
class LibvirtConfigGuestSerial(LibvirtConfigGuestChar):
    ...
    def __init__(self, **kwargs):
        super(LibvirtConfigGuestSerial, self).__init__(rootname="serial", **kwargs)

class LibvirtConfigGuestConsole(LibvirtConfigGuestChar):

    def __init__(self, **kwargs):
        super(LibvirtConfigGuestConsole, self).__init__(rootname="console", **kwargs)


class LibvirtConfigGuest(LibvirtConfigObject):

    def __init__(self, **kwargs):
        super(LibvirtConfigGuest, self).__init__(rootname="domain", **kwargs)
...
class LibvirtConfigCPU(LibvirtConfigObject):
    ...
    def __init__(self, **kwargs):
        super(LibvirtConfigCPU, self).__init__(rootname="cpu", **kwargs)
    ...
    def format_dom(self):
        ...
        if self.sockets is not None and self.cores is not None and self.threads is not None:
