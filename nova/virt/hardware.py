...
class VirtPCIDeviceInfo(object):
    ...
    def __init__(self, dev_type, dev_id, label,
        ...
        if address is None:
            raise exception.PCIDeviceAddressMissing()

        if (dev_type == VirtPCIDeviceInfo.DEV_TYPE_VIRT_FUNC and
            phys_function is None):
            raise exception.PCIDeviceParentAddressMissing()
