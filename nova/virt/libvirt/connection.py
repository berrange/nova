...
class LibvirtConnection(driver.ComputeDriver):
    ...
    def get_console_output(self, instance):
        ...
        if node is None:
            raise exception.Error(_("Guest does not have any console available"))
    ...
    def get_guest_config(self, instance, network_info, image_meta, rescue,
            ...
            if rescue:
                ...
                if instance['kernel_id']:
                    ...
                    if FLAGS.libvirt_type == "xen":
                        ...
                        guest.os_cmdline = "root=" + (root_device_name or "/dev/vda") + " console=ttyS0"
        ...
        if FLAGS.libvirt_type == "lxc":
            ...
            if rescue:
                ...
                for vol in block_device_mapping:
                    connection_info = vol['connection_info']
                    mountpoint = vol['mount_device']
                    guest.add_device(self.volume_driver_method('connect_volume',
                                                          connection_info,
                                                          mountpoint).to_xml())
        ...
        for (network, mapping) in network_info:
            guest.add_device(self.vif_driver.plug(instance, network, mapping))
